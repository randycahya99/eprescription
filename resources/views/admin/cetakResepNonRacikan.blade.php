...
<body>
    ...
    <div>
        <center><h2>Resep Obat {{$resep->nama_resep}}</h2></center>
    </div>
    <hr>
    <div>
        <div class="tes" style="font-family: sans-serif; color: #232323;">
            ...
            <div style="margin-left: 30px">
                ...
                <p style="font-weight: bold; line-height: 0.5">Resep</p>
                <p style="margin-left: 30px; line-height: 0.5">- {{$resep->obats->obatalkes_nama}} ({{$resep->qty_obat}})</p>
